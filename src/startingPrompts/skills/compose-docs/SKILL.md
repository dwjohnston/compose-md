---
name: compose-docs
description: Edit and regenerate this project's agent instruction files (AGENTS.md, CLAUDE.md, SKILL.md, etc.), which are generated by compose-md from fragments and approaches. Also update your memory when you learn something durable about this project's docs workflow.
---
...
5. If you learn something durable about this project's fragments, approaches, or conventions along the way, update your memory too — not just the fragment.
